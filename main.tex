...
In this paper, we focus on a restriction of the Process Hitting with two priorities and a specific behaviour of the components, that is sufficient to tackle the aforementioned problem of cooperations.
...
Our method thus allows to efficiently under-approximate local reachability properties in asynchronous multivalued networks.
\end{abstract}
\begin{keyword}
