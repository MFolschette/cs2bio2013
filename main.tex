...
We also show that these priorities allow to represent accurate Boolean gates in order to model
...
Furthermore, we develop in this paper a new refinement for the under-approximation of the static analysis
...
Finally, we show that Process Hitting allows to accurately model
any Asynchronous Discrete Networks, either Boolean or multivalued.
Our static analysis method thus allows to efficiently under-approximate reachability properties
