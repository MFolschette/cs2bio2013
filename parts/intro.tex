...
\todo{Compléter les contributions}
...
we provide in \pref{sec:encodings} a “flattening” of any Process Hitting model into
...
also called “Logical Networks” in~\cite{Thomas95,deJong02}.
...
\modMF{
The main addition in this paper compared to \cite{FPMR13-CS2Bio} are the following:
\pref{th:bisimPHP} states that any Process Hitting model with any number of classes of priorities
...
\pref{thm:ordered-ua} gives a method to cope with successive reachability,
and obtain more conclusive results in the case of several successive objectives;
\todo{def extraction} allows to extract a concrete scenario when our static analysis method
is conclusive.
%All aim at extending the application range of the static analysis we developed.
}
