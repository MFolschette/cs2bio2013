...
with the Process Hitting using two classes of priorities
and prove a weak bisimulation relation.
This translation is important as it allows to efficiently study the dynamics ADNs
by using the static analysis developed in \pref{sec:sa};
indeed, the bisimulation relation ensures that the dynamics of the
resulting PH model are accurately the same than the original.
Furthermore, the obtained model is ensured to respect
all Conditions of \pref{ssec:hypothesis}.
