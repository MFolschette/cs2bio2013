...
we split it following \pref{ssec:ordered-ua}.
\todo{update method: extract a witness scenario, and use the resulting state for
the rest - remove $\Cap$, $\allprocs$, $\lastprocs$, etc.}
...
In conclusion, by following \pref{ssec:ordered-ua} on these saturated graphs of local causality,
