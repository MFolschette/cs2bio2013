...
(which is: reaching $p$ from the initial state) according to its children.
...
In the end, this recursive procedures builds a scenario from $s\subset\ctx$ to a state containing $p$.
