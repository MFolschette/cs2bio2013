...
$\w\in\OS$ such that $\forall a\in\PHsort(\w), \first_a(\w)\in s$,
$\concr(\w)$ is the set of scenarios matching with $\w$:
\begin{align*}
...
\todo{name + prototype of the procedure}
...
$ps = \{ a_i \in\Proc\mid a\in\PHs, a_i\in\PHl(a)\}$,
