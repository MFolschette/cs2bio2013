...
\subsection{Comparison with the Process Hitting and Modelling of Cooperations}
...
% In \pref{ssec:flattening}, we also show that Process Hitting models with
% classes of priorities~\cite{FPMR13-CS2Bio}
% can also be encoded into AANs.
...
%are a very common in biological systems.
