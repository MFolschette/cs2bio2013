...
\begin{definition}[Process Hitting $n$-reduction] \towrite{Revoir terminologie}
  ...
  $$\restriction{\PH}{n} = (\PHs; \PHl; \PHa^{\langle n \rangle})$$
  and:
...
Let $\PH$ be a PH model on which we want to apply the static analysis. This PH has to regard the two restrictions below.
