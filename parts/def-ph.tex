...
Prédécesseurs prioritaires :
$$\Vs(a) = \{ b \in \PHs \mid \PHh^1(b, a) \neq \emptyset \}$$
...
The studied PH is only composed of sorts representing regular components with priority $2$ and of cooperative sorts with priority $1$.
