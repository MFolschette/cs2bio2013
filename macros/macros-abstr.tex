...
\tikzstyle{Asol}=[draw,circle,minimum size=5pt,inner sep=0,node distance=1.7cm]
\tikzstyle{Aproc}=[draw]
\tikzstyle{Aobj}=[node distance=2cm]
\tikzstyle{Anos}=[node distance=1cm,font=\Large]
